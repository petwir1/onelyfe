...
/datum/alch_cauldron_recipe/doompoison
	...
	output_reagents = list(/datum/reagent/strongpoison = 200)
...
/datum/alch_cauldron_recipe/big_stam_poison
	...
	skill_required = SKILL_LEVEL_EXPERT // Strong poison should be more difficult to make
	output_reagents = list(/datum/reagent/strongstampoison = 200)
...
/datum/alch_cauldron_recipe/big_health_potion
	...
	output_reagents = list(/datum/reagent/medicine/stronghealth = 100)//it has an extremely easy recipe compared to regular red
...
/datum/alch_cauldron_recipe/big_mana_potion
	...
	output_reagents = list(/datum/reagent/medicine/strongmana = 200)
...
/datum/alch_cauldron_recipe/big_stamina_potion
	...
	output_reagents = list(/datum/reagent/medicine/strongstam = 200)
